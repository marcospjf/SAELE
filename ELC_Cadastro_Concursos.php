    ...
    <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size: 10pt;">
        ...
        <tr class="Linha2">
            <td colspan="3"> &nbsp;
                ...
                <label><input type="radio" name="IndContagem" id="IndContagemN" value="N" /> N&atilde;o</label>
			</td>
		</tr>
        <tr class="Linha1">
        ...
        <tr class="Linha2">
            <td colspan="3"> &nbsp;
                <label><input type="radio" name="Modalidade" id="ModalidadeE" value="E" /> Elei&ccedil;&atilde;o</label>
